...
using BuisnessLogicLayer.Services.PostsSearchStrategy;
...
public class PostService : IPostService
{
    ...
    public  IEnumerable<PostModel> GetPostsSearch(string text)
    {
        ...
        var searchStrategyContext = new BlogPostSearchContext(new TitleSearchStrategy());

        posts = searchStrategyContext.Search(text, posts);
        
        return posts.Select(_mapper.Map<PostModel>);
    }
}
